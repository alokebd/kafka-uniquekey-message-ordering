package com.java2tech.kafka.component;
...
import static com.java2tech.kafka.util.TestEventData.INBOUND_DATA;
...
public class EndToEndCT {
    ...
    public void testFlow() throws Exception {
        ...
        for (int i=0; i<totalMessages; i++) {
            ...
            InboundPayload testPayload = TestEventData.buildDemoInboundPayload(i+1);
